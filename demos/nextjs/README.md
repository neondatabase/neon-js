...
Follow these steps to set up `@neondatabase/neon-js/auth/next` in your Next.js project:
...
# or
pnpm add @neondatabase/neon-js 
# or
yarn add @neondatabase/neon-js
```
...
/* app/globals.css */
@import "tailwindcss";
@import "@neondatabase/neon-js/auth/ui/tailwind";
```
...
- [Neon Auth - Next.js Documentation](https://neon.com/docs/auth/quick-start/nextjs)
