...
- On middleware/proxy login redirects, **never drop URL query params**—preserve **`neon_auth_session_verifier`** even when the OAuth challenge cookie is absent or the verifier exchange fails; don't allow the protected request through instead.
