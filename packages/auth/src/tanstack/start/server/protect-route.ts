 ...
 *
 * @param authConfig - Neon Auth configuration
 * @param routeConfig - Route protection configuration
 * @returns Promise that resolves if access is allowed, or throws redirect
 ...
 *       });
 *     } catch (error) {
 *       // Error is a redirect, it will be handled by TanStack Router
 *       throw error;
 *     }
 *   },
 * });
