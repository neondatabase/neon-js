-- This file was generated by `drizzle-kit pull` after introspecting the database.
-- The SQL is commented out because these tables already exist (managed by Neon Auth
-- and by `drizzle-kit push`). This is normal drizzle-kit pull behavior — it wraps
-- everything in a comment block so it doesn't re-run on migrate.
-- If you ever need to run this migration manually, uncomment the SQL below.
/*
